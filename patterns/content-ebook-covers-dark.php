 ...
 * Slug: powder-studio/content-ebook-covers-dark
 * Categories: content
 */
?>
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background" style="margin-top:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<div class="wp-block-group">
		...
		<p class="has-text-align-center has-tiny-font-size" style="font-style:normal;font-weight:400;text-transform:uppercase"><?php echo esc_html__( 'Meet Powder', 'powder-studio' ); ?></p>
		<!-- /wp:paragraph -->
		<!-- wp:heading {"textAlign":"center","style":{"typography":{"letterSpacing":"-1px"}},"fontSize":"max-60"} -->
		<h2 class="wp-block-heading has-text-align-center has-max-60-font-size" style="letter-spacing:-1px"><?php echo esc_html__( 'Are you ready to design with WordPress?', 'powder-studio' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-cover is-light" style="padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small)"><span aria-hidden="true" class="wp-block-cover__background has-base-background-color has-background-dim-100 has-background-dim"></span><div class="wp-block-cover__inner-container">
				...
				<div class="wp-block-group has-border-color has-contrast-border-color" style="border-width:1px;min-height:400px;padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--medium)">
					...
					<h3 class="wp-block-heading has-text-align-center has-x-large-font-size" style="line-height:1.2;text-transform:uppercase"><?php echo esc_html__( 'Sample Title', 'powder-studio' ); ?></h3>
					<!-- /wp:heading -->
					<!-- wp:paragraph {"align":"center","fontSize":"tiny"} -->
					<p class="has-text-align-center has-tiny-font-size"><?php echo esc_html__( 'By: Brian Gardner', 'powder-studio' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div></div>
