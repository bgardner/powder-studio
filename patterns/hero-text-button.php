 ...
 * Slug: powder-studio/hero-text-button
 * Categories: hero
 */
?>
...
<div class="wp-block-group alignfull" style="margin-top:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<div class="wp-block-group">
		...
		<h1 class="wp-block-heading has-text-align-center has-max-72-font-size"><?php echo esc_html__( 'Are you ready to design with WordPress?', 'powder-studio' ); ?></h1>
		<!-- /wp:heading -->
		<!-- wp:paragraph {"align":"center"} -->
		<p class="has-text-align-center"><?php echo esc_html__( 'Redefine your space with a stylish, modern design.', 'powder-studio' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
