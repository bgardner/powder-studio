 ...
 * Slug: powder-studio/content-progress-bars-dark
 * Categories: content
 */
?>
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background" style="margin-top:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:100%">
			...
			<div class="wp-block-group has-small-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #1', 'powder-studio' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '100%', 'powder-studio' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:90%">
			...
			<div class="wp-block-group has-small-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #2', 'powder-studio' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '90%', 'powder-studio' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"backgroundColor":"base","layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:80%">
			...
			<div class="wp-block-group has-small-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #3', 'powder-studio' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '80%', 'powder-studio' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"backgroundColor":"base","layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:70%">
			...
			<div class="wp-block-group has-small-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #4', 'powder-studio' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '70%', 'powder-studio' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"backgroundColor":"base","layout":{"type":"constrained"}} -->
	...
	<div class="wp-block-columns are-vertically-aligned-bottom is-not-stacked-on-mobile">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:60%">
			...
			<div class="wp-block-group has-small-font-size">
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( 'Item #5', 'powder-studio' ); ?></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p><?php echo esc_html__( '60%', 'powder-studio' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			<!-- wp:group {"backgroundColor":"base","layout":{"type":"constrained"}} -->
