 ...
 * Slug: powder-studio/content-feature-columns-dark
 * Categories: content
 */
?>
...
<div class="wp-block-group alignfull has-base-color has-contrast-background-color has-text-color has-background" style="margin-top:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-center" style="margin-top:var(--wp--preset--spacing--x-small)">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<h2 class="wp-block-heading has-max-48-font-size" style="letter-spacing:-0.5px"><?php echo esc_html__( 'Are you ready to start designing with WordPress?', 'powder-studio' ); ?></h2>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:column -->
		<!-- wp:column {"verticalAlignment":"center"} -->
	...
	<div class="wp-block-columns alignwide" style="margin-top:var(--wp--preset--spacing--large)">
		...
		<div class="wp-block-column">
			...
			<h2 class="wp-block-heading has-medium-font-size"><?php echo esc_html__( 'Meet Powder', 'powder-studio' ); ?></h2>
			<!-- /wp:heading -->
			<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"5px"}}},"fontSize":"small"} -->
			<p class="has-small-font-size" style="margin-top:5px"><?php echo esc_html__( 'Are you ready to design with WordPress?', 'powder-studio' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		<!-- wp:column -->
