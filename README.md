...
See the Powder Studio theme in action at [https://powderstudio.com/demo/](https://powderstudio.com/demo/).
...
4. In the WordPress admin, use the Appearance > Themes screen to activate Powder Studio.
